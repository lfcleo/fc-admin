    ...
    <el-container>
        <el-main class="nopadding">
            <fc-table stripe ref="fcTableRef" rowKey="name" :requestApi="getTableList" :columns="columns"
                :showColumnBtn="false" :showRefreshBtn="false">
                ...
                <template #toolButtons>
                    <div style="width: 100%;display: flex;flex-direction: row;align-items: center;">
                        <el-button type="danger" plain icon="Delete" :disabled="fcTableRef?.selectedList.length == 0"
                            circle></el-button>
                        <div style="margin-left: 10px">隐藏了列定义showColumnBtn和刷新按钮showRefreshBtn。自定义了一个删除多个数据的按钮，试试多选后看按钮变化
                        </div>
                    </div>
                </template>
            </fc-table>
